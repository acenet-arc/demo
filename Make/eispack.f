C $Header: /home/ross/cvsroot/parnum/eispack.f,v 1.1.1.1 2004/08/24 20:02:27 ross Exp $
C
C     ------------------------------------------------------------------
C
...
C                RADIX = 2.0D0 FOR LONG FORM ARITHMETIC
C                ON Sun-3 ::::::::::
      DATA RADIX/Z'4000000000000000'/
C
      B2 = RADIX * RADIX
      K = 1
      L = N
...
C                THE RELATIVE PRECISION OF FLOATING POINT ARITHMETIC.
      DATA MACHEP/2.220446049250313E-16/
C
      IERR = 0
      IF (M .EQ. 0) GO TO 1001
      MB = MBW
...
C     ARITHMETIC IS REAL EXCEPT FOR THE REPLACEMENT OF THE ALGOL
C     PROCEDURE CDIV BY COMPLEX DIVISION AND USE OF THE SUBROUTINES
C     CDSQRT AND DCMPLX IN COMPUTING COMPLEX SQUARE ROOTS.
C
C     QUESTIONS AND COMMENTS SHOULD BE DIRECTED TO B. S. GARBOW,
C     APPLIED MATHEMATICS DIVISION, ARGONNE NATIONAL LABORATORY
C
...
C     :::::::::: FORM SHIFT ::::::::::
  300 IF (L .EQ. EN) GO TO 660
      ...
      Z3 = CDSQRT(DCMPLX(YR**2-YI**2+XR,2.0D0*YR*YI+XI))
      ZZR = DREAL(Z3)
      ZZI = DIMAG(Z3)
...
C                INTERVAL CONTAINING ALL THE EIGENVALUES ::::::::::
   ...
   40 CONTINUE
C
      X1 = DMAX1(DABS(XU),DABS(X0)) * MACHEP * DFLOAT(N)
      XU = XU - X1
      T1 = XU
      X0 = X0 + X1
      T2 = X0
