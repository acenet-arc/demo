c $Header: /home/ross/cvsroot/parnum/lebedev.f,v 1.3 2005/01/18 20:40:10 ross Exp $
       subroutine LEBQUA(nRequested,x,y,z,w,nReturned,lReturned)
c
c      Calls the appropriate Lebedev-Laikov routine for
c      the requested grid size.
C
c    Inputs:
c      nRequested  Requested number of grid points
c    Outputs:
c      x,y,z       Grid point locations (on surface of unit sphere)
c      w           Corresponding weights
c      nReturned   Actual number of grid points returned -- will
c                  not exceed nRequested
c      lReturned   Algebraic order of the quadrature, ie. any 
c                  spherical harmonic expansion up to this order
c                  is integrated exactly by this formula
c
c      Ross M. Dickson, Queen's Univ., 2003 Sep 18
c
       implicit none
       integer,        intent(in) :: nRequested
       real(kind(1d0)),intent(out):: x(*),y(*),z(*),w(*)
       integer,        intent(out):: nReturned,lReturned
c
       select case (nRequested)
       case (   0:   5)
          nReturned=0
          lReturned=0
       case (   6:  13)
          call LD0006(x,y,z,w,nReturned)
          lReturned=3
       case (  14:  25)
          call LD0014(x,y,z,w,nReturned)
          lReturned=5
       case (  26:  37)
          call LD0026(x,y,z,w,nReturned)
          lReturned=7
       case (  38:  49)
          call LD0038(x,y,z,w,nReturned)
          lReturned=9
       case (  50:  73)
          call LD0050(x,y,z,w,nReturned)
          lReturned=11
       case (  74:  85)
          call LD0074(x,y,z,w,nReturned) ! negative weights
          lReturned=13
       case (  86: 109)
          call LD0086(x,y,z,w,nReturned)
          lReturned=15
       case ( 110: 145)
          call LD0110(x,y,z,w,nReturned)
          lReturned=17
       case ( 146: 169)
          call LD0146(x,y,z,w,nReturned)
          lReturned=19
       case ( 170: 193)
          call LD0170(x,y,z,w,nReturned)
          lReturned=21
       case ( 194: 229)
          call LD0194(x,y,z,w,nReturned)
          lReturned=23
       case ( 230: 265)
          call LD0230(x,y,z,w,nReturned) ! negative weights
          lReturned=25
       case ( 266: 301)
          call LD0266(x,y,z,w,nReturned) ! negative weights
          lReturned=27
       case ( 302: 349)
          call LD0302(x,y,z,w,nReturned)
          lReturned=29
       case ( 350: 433)
          call LD0350(x,y,z,w,nReturned)
          lReturned=31
       case ( 434: 589)
          call LD0434(x,y,z,w,nReturned) ! orders have gaps from here
          lReturned=35
       case ( 590: 769)
          call LD0590(x,y,z,w,nReturned)
          lReturned=41
       case ( 770: 973)
          call LD0770(x,y,z,w,nReturned)
          lReturned=47
       case ( 974:1201)
          call LD0974(x,y,z,w,nReturned) ! orders estimated below here
          lReturned=53
       case (1202:1453)
          call LD1202(x,y,z,w,nReturned)
          lReturned=59
       case (1454:1729)
          call LD1454(x,y,z,w,nReturned)
          lReturned=65
       case (1730:2029)
          call LD1730(x,y,z,w,nReturned)
          lReturned=71
       case (2030:2353)
          call LD2030(x,y,z,w,nReturned)
          lReturned=77
       case (2354:2701)
          call LD2354(x,y,z,w,nReturned)
          lReturned=83
       case (2702:3073)
          call LD2702(x,y,z,w,nReturned)
          lReturned=89
       case (3074:3469)
          call LD3074(x,y,z,w,nReturned)
          lReturned=95
       case (3470:3889)
          call LD3470(x,y,z,w,nReturned)
          lReturned=101
       case (3890:4333)
          call LD3890(x,y,z,w,nReturned)
          lReturned=107
       case (4334:4801)
          call LD4334(x,y,z,w,nReturned)
          lReturned=113
       case (4802:5293)
          call LD4802(x,y,z,w,nReturned)
          lReturned=119
       case (5294:5809)
          call LD5294(x,y,z,w,nReturned)
          lReturned=125
       case default
          call LD5810(x,y,z,w,nReturned)
          lReturned=131
       end select
       return
       end
c
       subroutine lebedev_size(nRequested,nReturned,lReturned)
       implicit none
       integer nRequested,nReturned,lReturned
       select case (nRequested)
       case (   0:   5)
          nReturned=0
          lReturned=0
...
c
       ...
       real(kind(1d0)),intent(out):: x(*),y(*),z(*),w(*)
       real(kind(1d0)),intent(in) :: v
       real(kind(1d0)) a,b,c
crmd 
crmd   These subroutines generate
